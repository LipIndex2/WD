...
@BaseView.registView
export class MainTaskRewardView extends BaseView {

    protected viewRegcfg: viewRegcfg = {
        UIPackName: "MainTaskReward",
        ViewName: "MainTaskRewardView",
    ...
    protected viewNode = {
        ...
        RewardShow1: <MainTaskRewardViewRewardItem>null,
        RewardShow2: <MainTaskRewardViewRewardItem>null,
    };

    protected extendsCfg = [
        { ResName: "ItemReward", ExtendsClass: MainTaskRewardViewRewardItem }
    ]

    InitData(param_t: { x: number, y: number, rewards: any[] }) {
...
class MainTaskRewardViewRewardItem extends BaseItem {
    protected viewNode = {
