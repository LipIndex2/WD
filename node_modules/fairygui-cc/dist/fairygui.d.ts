...
declare module 'fairygui-cc/tween/GTween' {
    ...
    export class GTween {
        ...
        static to(start: number, end: number, duration: number, autoKill?: boolean): GTweener;
        static to2(start: number, start2: number, end: number, end2: number, duration: number, autoKill?: boolean): GTweener;
        static to3(start: number, start2: number, start3: number, end: number, end2: number, end3: number, duration: number, autoKill?: boolean): GTweener;
        static to4(start: number, start2: number, start3: number, start4: number, end: number, end2: number, end3: number, end4: number, duration: number, autoKill?: boolean): GTweener;
...
declare module 'fairygui-cc/tween/GTweener' {
    ...
    export class GTweener {
        ...
        setTotalTimeScale(value: number): GTweener;
        setDirection(value: 1 | -1): GTweener;
        ...
        setPausedNUM(paused: boolean): GTweener;
        /**
