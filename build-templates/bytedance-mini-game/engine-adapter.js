...
function downloadBundle(nameOrUrl, options, onComplete) {
  var bundleName = cc.path.basename(nameOrUrl);
      ...
      } else if (cc.assetManager.downloader.remoteBundleVers && cc.assetManager.downloader.remoteBundleVers[bundleName]) {
        version = cc.assetManager.downloader.remoteBundleVers[bundleName]
      } else
        version = cc.assetManager.downloader.bundleVers[bundleName];
      var version_js = options.version || cc.assetManager.downloader.bundleVers[bundleName]
      var suffix_js = version ? "".concat(version_js, ".") : '';
  ...
  if (subpackages[bundleName]) {
    ...
    if (REGEX.test(nameOrUrl) || nameOrUrl.startsWith(getUserDataPath())) {
      url = nameOrUrl;
          js = "src/bundle-scripts/".concat(bundleName, "/index.").concat(suffix_js, "js");
      ...
      url = "assets/".concat(bundleName);
          js = "assets/".concat(bundleName, "/index.").concat(suffix_js, "js");
    }
